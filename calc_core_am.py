...
def calc_core_am(abundance, rl):
    fname = "/media/luna1/dkorytov/data/OuterRim/cores_500L/03_31_2018.OR.323.coreproperties"
    ...
    r_bins = np.logspace(-1,1.5,64)
    r_bins_cen = dtk.bins_avg(r_bins)
    xi = calc_wp(cat, r_bins, 500)
    save_wp('cache/wps/cmass_core_am.hdf5', r_bins_cen, xi)
